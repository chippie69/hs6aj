...
export const metadata: Metadata = {
  ...
  keywords: ['สมาคมวิทยุสมัครเล่น', 'วิทยุสมัครเล่น', 'พิจิตร', 'สมาคมวิทยุสมัครเล่นจังหวัดพิจิตร', 'วิทยุพิจิตร', 'HS6AJ', '145.6875', 'E24BD', 'เชื่อมโยงเครือข่ายพิจิตร', 'echolink phichit', 'allstarlink phichit', 'dstar phichit', '597910', 'E25LO-R', 'E25LO-L', 'XLX 149 Module P'],
  openGraph: {
    title: 'สมาคมวิทยุสมัครเล่นจังหวัดพิจิตร HS6AJ',
    description: 'เว็บไซต์อย่างเป็นทางการของสมาคมวิทยุสมัครเล่นจังหวัดพิจิตรอยู่ภายใต้การกำกับดูแลของ กสทช. มีเนื้อหาต่าง ๆ ข่าวสาร กิจกรรม และข้อมูลสำหรับนักวิทยุสมัครเล่น',
    url: 'https://hs6aj.com',
